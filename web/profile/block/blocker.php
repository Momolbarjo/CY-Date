<!DOCTYPE html>
<html lang="en">
<!--  Programme HTML/CSS/PHP qui permet d'afficher un message prevenant l'utilisateur X qu'il a bloqué Y quand X essaye d'accéder au profil de Y. Permet à X de débloquer Y  -->
